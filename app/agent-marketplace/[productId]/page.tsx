      ...
      conciergeSteps: [
        {
          ...
          description: 'Connect your Facebook Business account and define your lead qualification criteria.'
        },
        {
          title: 'AI Training & Customization',
          description: 'Train the AI on your specific products, pricing, and conversation style.'
        },
        {
          title: 'Testing & Optimization',
          description: 'Test the system with real conversations and fine-tune responses.'
        },
        {
          title: 'Go-Live & Monitoring',
          description: 'Launch the system and continuously monitor performance.'
        }
      ]
    },
    'gmail-triage': {
      ...
      capabilities: [
        {
          ...
          description: 'Automatically sorts emails by priority, topic, and required action.'
        },
        {
          title: 'Smart Drafting',
          description: 'Creates personalized response drafts based on email content and context.'
        },
        {
          title: 'Priority Scoring',
          description: 'Assigns urgency levels to ensure important emails get immediate attention.'
        }
      ],
      conciergeSteps: [
        {
          title: 'Email Analysis Setup',
          description: 'Configure inbox access and define categorization rules.'
        },
        {
          title: 'Response Template Creation',
          description: 'Develop personalized response templates for different scenarios.'
        },
        {
      ...
      capabilities: [
        {
          ...
          description: 'Automatically gathers and processes data from multiple sources.'
        },
        {
          title: 'Real-time Processing',
          description: 'Processes and analyzes data in real-time for immediate insights.'
        },
        {
      ...
      <div className="bg-[#F9F9F9] border-b border-[#E5E5E5] py-4">
        <div className="container mx-auto px-4">
          <nav className="flex items-center gap-2 text-sm">
            <Link href="/" className="text-[#0A0A0A]/60 hover:text-[#FF6B00]">HOME</Link>
            <span className="text-[#0A0A0A]/40">/</span>
            <Link href="/agent-marketplace" className="text-[#0A0A0A]/60 hover:text-[#FF6B00]">MARKETPLACE</Link>
            <span className="text-[#0A0A0A]/40">/</span>
            <span className="text-[#0A0A0A] font-mono text-xs">{product.breadcrumb}</span>
          </nav>
        </div>
      </div>
      ...
      <div className="bg-[#0A0A0A] text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            Enterprise-grade automation solution with full concierge setup and ongoing optimization.
          </p>
        </div>
      </div>
