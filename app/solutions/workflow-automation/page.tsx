...
export const metadata: Metadata = {
  ...
  description: 'Automate repetitive tasks and streamline your business processes with custom workflow automation solutions powered by n8n and modern technologies.',
}
