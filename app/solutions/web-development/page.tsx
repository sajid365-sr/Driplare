...
export const metadata: Metadata = {
  ...
  description: 'Custom full-stack web development using MERN stack (MongoDB, Express.js, React, Node.js). Build scalable, performant web applications with modern technologies.',
}
