...
const insightPosts = [
  {
    ...
    excerpt: "Explore how artificial intelligence is transforming the way websites are built and maintained.",
    date: "April 15, 2025",
  ...
  },
  {
    ...
    excerpt: "Learn how to leverage customer data to create targeted marketing campaigns that deliver results.",
    date: "April 10, 2025",
  ...
  },
  {
    ...
    excerpt: "Stay ahead of the curve with these emerging user experience design trends.",
    date: "April 5, 2025",
    category: "Web Design",
  ...
  },
  {
    ...
    excerpt: "Best practices for creating conversational AI that enhances rather than frustrates the user experience.",
    date: "March 28, 2025",
    category: "AI Technology",
    image: "https://images.unsplash.com/photo-1677442135136-760c813dfc5c?q=80&w=2232&auto=format&fit=crop"
  },
  {
    ...
    excerpt: "Technical strategies to improve your site's loading speed, interactivity, and visual stability.",
    date: "March 21, 2025",
  ...
  },
  {
    ...
    excerpt: "Navigating the complex ethical landscape when implementing AI solutions for clients.",
    date: "March 15, 2025",
    category: "AI Technology",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop"
  }
...
const featuredPost = {
  ...
  excerpt: "Artificial intelligence is no longer just a buzzword—it's fundamentally changing how designers work. From automated layout suggestions to intelligent image generation and content recommendations, AI-powered tools are augmenting human creativity in unprecedented ways.",
  date: "April 22, 2025",
  category: "AI Technology",
  image: "https://images.unsplash.com/photo-1677442135136-760c813dfc5c?q=80&w=2232&auto=format&fit=crop",
  readTime: "8 min read"
...
const Insights = () => {
  ...
  useEffect(() => {
    if (searchTerm === "") {
      ...
      const filtered = insightPosts.filter(post => 
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Stay ahead with the latest trends, strategies, and insights in web development, digital marketing, and AI innovation.
            </p>
          </motion.div>
          ...
          >
            <div className="relative overflow-hidden rounded-xl">
              ...
              <div className="relative p-8 md:p-12 lg:p-16 flex flex-col h-full min-h-[400px] justify-end">
                <span className="text-primary font-medium mb-3">{featuredPost.category} • {featuredPost.date} • {featuredPost.readTime}</span>
              ...
              >
                <Card className="overflow-hidden h-full hover:shadow-lg transition-shadow cursor-pointer border-0 bg-card">
                  ...
                  <CardContent className="p-6">
                    <span className="text-primary text-sm font-medium">{post.category} • {post.date}</span>
          ...
          >
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground mb-8">
                Subscribe to receive the latest insights on AI, web design, and digital marketing directly to your inbox.
              </p>
              <div className="flex flex-col sm:flex-row gap-3">
                <Input placeholder="Enter your email" className="h-12 bg-background" />
                <Button className="h-12 bg-primary hover:bg-primary/90">Subscribe</Button>
              </div>
            </div>
          </motion.div>
        </div>
