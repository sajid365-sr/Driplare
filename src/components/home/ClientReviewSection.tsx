...
const testimonials: Testimonial[] = [
  {
    ...
    testimonial:
      "Driplare transformed our digital landscape completely. Their expertise in web solutions helped us modernize our entire infrastructure.",
  },
  {
    id: "2",
    name: "Sarah Chen",
    ...
    testimonial:
      "The seamless integration and robust features transformed our workflow completely. Their team's technical expertise was exceptional.",
  },
  {
    id: "3",
    ...
    testimonial:
      "Their attention to detail and technical expertise exceeded our expectations. The results have been transformative for our business.",
  },
];
    ...
    >
      <div className="container px-4 mx-auto">
        <div className="text-center mb-14">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 fade-in slide-up">
            Words from Our Clients
          </h2>
          <p className="text-lg text-gray-300 dark:text-gray-300 max-w-3xl mx-auto fade-in slide-up">
            As a strategic partner to our clients across different industries,
            we help them deliver their business goals and drive technology-led
            transformations. Our clients worldwide have achieved significant
            business results using our world-class solutions and have recognized
            us for our efforts. Know more about our client's experience with us
            and read our trusted{" "}
