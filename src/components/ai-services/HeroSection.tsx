...
export function HeroSection() {
  return (
    <section className="relative flex items-center justify-center min-h-[80vh] overflow-hidden bg-gradient-to-br from-[#211c29] via-[#1a1f2c] to-[#14121b]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none" style={{background: "radial-gradient(ellipse at 40% 40%, rgba(30,174,219,0.10) 0%, rgba(20,17,27,0.5) 100%)"}} />
      ...
      >
        ...
        >
          Harness AI to elevate support, streamline workflows, and scale smarter.
        </motion.p>
        <motion.div initial={{ opacity: 0, y: 52 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.28, duration: 0.7 }}>
          <Button
