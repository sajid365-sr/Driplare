...
import { Menu, ChevronDown, ChevronRight, Code, BarChart2, Brain, MessageSquareCode, UserRound, SlidersHorizontal } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
        ...
        <nav className="flex flex-col space-y-5 mt-12">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="solutions" className="border-b-0">
              <AccordionTrigger className="text-lg font-medium py-0">Solutions</AccordionTrigger>
              <AccordionContent>
