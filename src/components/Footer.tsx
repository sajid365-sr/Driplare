        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 border-t border-border">
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/web-design" className="text-muted-foreground hover:text-primary transition-colors">Web Design & Development</Link></li>
              <li><Link to="/digital-marketing" className="text-muted-foreground hover:text-primary transition-colors">Digital Marketing</Link></li>
              <li><Link to="/ai-services" className="text-muted-foreground hover:text-primary transition-colors">AI Solutions</Link></li>
              <li><Link to="/ai-services#chatbot" className="text-muted-foreground hover:text-primary transition-colors">Chatbot Integration</Link></li>
              <li><Link to="/ai-services#agents" className="text-muted-foreground hover:text-primary transition-colors">Custom AI Agents</Link></li>
              <li><Link to="/ai-services#automation" className="text-muted-foreground hover:text-primary transition-colors">AI Automation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <a href="mailto:info@driplare.com" className="text-muted-foreground hover:text-primary transition-colors">info@driplare.com</a>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">100 Innovation Drive<br />Tech City, CA 94103</span>
              </li>
            </ul>
