        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-xl text-white/70 font-inter font-light leading-relaxed max-w-2xl mx-auto">
              Let's begin with a Systems Audit to see where we can engineer your next 20% in efficiency.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-8">
            <div className="bg-white/10 p-4 rounded-none border border-white/20">
              <div className="font-mono text-xs text-white/60 mb-2">[ PHASE_01 ]</div>
              <div className="font-montserrat font-bold text-white text-sm">Systems Audit</div>
              <div className="text-xs text-white/70 mt-1">1-2 weeks</div>
            </div>

            <div className="bg-white/10 p-4 rounded-none border border-white/20">
              <div className="font-mono text-xs text-white/60 mb-2">[ PHASE_02 ]</div>
              <div className="font-montserrat font-bold text-white text-sm">Architecture</div>
              <div className="text-xs text-white/70 mt-1">2-3 weeks</div>
            </div>

            <div className="bg-white/10 p-4 rounded-none border border-white/20">
              <div className="font-mono text-xs text-white/60 mb-2">[ PHASE_03 ]</div>
              <div className="font-montserrat font-bold text-white text-sm">Deployment</div>
              <div className="text-xs text-white/70 mt-1">3-6 weeks</div>
            </div>

            <div className="bg-white/10 p-4 rounded-none border border-white/20">
              <div className="font-mono text-xs text-white/60 mb-2">[ PHASE_04 ]</div>
              <div className="font-montserrat font-bold text-white text-sm">Optimization</div>
          ...
          <div className="bg-white/10 p-6 rounded-none border border-white/20 max-w-2xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
              <div>
                <div className="font-mono text-xs text-white/60 mb-1">AUDIT_DELIVERABLES:</div>
              ...
              <div>
                <div className="font-mono text-xs text-white/60 mb-1">METHODOLOGY:</div>
                <ul className="text-sm text-white/70 font-inter font-light space-y-1">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-lg px-6 py-3 rounded-none border border-white/20">
              ...
              <span className="font-mono text-sm text-white/70">
                METHODOLOGY_ACTIVE | AUDIT_READY | EFFICIENCY_ENGINEERING_AVAILABLE
              </span>
            </div>
          </motion.div>
        </motion.div>
