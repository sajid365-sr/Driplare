        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-[#0A0A0A]/70 max-w-2xl mx-auto font-montserrat">
              Select a 15-minute technical discovery slot directly on our calendar. No forms, no waiting.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-7 gap-2 mb-4">
                    {['SUN', 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT'].map(day => (
                      <div key={day} className="text-center text-sm font-bold text-[#0A0A0A]/60 font-mono py-2">
                        {day}
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="grid grid-cols-7 gap-2">
                    ...
                    {[...Array(3)].map((_, i) => (
                      <div key={`prev-${i}`} className="aspect-square flex items-center justify-center text-[#0A0A0A]/30 font-mono text-sm">
                        {28 + i}
                      </div>
                    ))}
                  ...
                  {/* Available Times */}
                  <div className="mt-6">
                    <h4 className="font-bold text-[#0A0A0A] mb-3">Available Times - Dec 26</h4>
            ...
            >
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#E5E5E5]">
                <h4 className="font-bold text-[#0A0A0A] mb-4">What to Expect</h4>
              ...
              <div className="bg-[#F5F5F5] p-6 rounded-2xl border border-[#E5E5E5]">
                <h4 className="font-bold text-[#0A0A0A] mb-3">Need a Different Time?</h4>
                <p className="text-sm text-[#0A0A0A]/70 mb-4">
                  Can't find a slot that works? Send us a message and we'll find a time.
                </p>
                <Button variant="outline" className="w-full border-[#0A0A0A] text-[#0A0A0A] hover:bg-[#0A0A0A] hover:text-white">
                  Contact Support
                </Button>
              </div>
            </motion.div>
