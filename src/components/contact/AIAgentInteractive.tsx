...
const initialMessages: Message[] = [
  {
    id: '1',
    type: 'ai',
    content: 'Hello! I\'m your AI Architect Assistant. I can help you book a technical discovery call. What type of project are you interested in?',
    timestamp: new Date()
  }
];
    ...
    setTimeout(() => {
      if (currentStep < qualifyingQuestions.length) {
        ...
        const aiResponse: Message = {
          id: (Date.now() + 1).toString(),
          type: 'ai',
          content: 'Perfect! Based on your responses, I think we\'d be a great fit. Would you like to book a technical discovery call?',
          timestamp: new Date()
        };
        setMessages(prev => [...prev, aiResponse]);
        setShowBooking(true);
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-[#0A0A0A]/70 max-w-2xl mx-auto font-montserrat">
              Our intelligent concierge will qualify your project and schedule a discovery call instantly.
            </p>
          </motion.div>
            ...
            >
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 border border-[#E5E5E5] shadow-xl">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-bold text-[#0A0A0A] text-center mb-4">Capabilities</h3>
                  <div className="grid grid-cols-1 gap-3">
                    {[
                      ...
                      <div key={index} className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-[#0A0A0A]/70 font-mono">{capability}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  >
                    ...
                    <div className="bg-[#F5F5F5] px-4 py-2 rounded-2xl">
                      <div className="flex gap-1">
                        ...
                        <div className="w-2 h-2 bg-[#0A0A0A]/40 rounded-full animate-bounce" style={{ animationDelay: '0.1s' }}></div>
                        <div className="w-2 h-2 bg-[#0A0A0A]/40 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                      </div>
                    </div>
                  </motion.div>
                )}
              ...
              {showBooking && (
                <div className="p-4 border-t border-[#E5E5E5] bg-gradient-to-r from-[#FF6B00]/5 to-[#FF6B00]/10">
                  <div className="text-center">
                    <h3 className="font-bold text-[#0A0A0A] mb-2">Ready to Book Your Discovery Call?</h3>
                    <p className="text-sm text-[#0A0A0A]/70 mb-4">
                      Based on your project details, we'd love to schedule a technical discussion.
                    </p>
