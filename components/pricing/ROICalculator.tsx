      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            Calculate how much money your business is losing to inefficient
            manual processes. This tool reveals the true cost of staying manual.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="bg-[#FF6B00] rounded-xl p-6 text-center">
                ...
                <p className="text-white/90 mb-4">
                  Your business is losing ${monthlyCost.toLocaleString()}{" "}
                  monthly to manual processes.
                </p>
