            ...
            <div className="p-10 md:p-16 flex flex-col justify-center relative z-10 border-b lg:border-b-0 lg:border-r border-white/10">
              ...
              <div className="grid grid-cols-2 gap-6 mb-10">
                <div className="space-y-1">
                  <p className="font-mono text-[9px] text-white/30 uppercase tracking-widest font-black">
                    Category
                  </p>
                  <p className="text-white font-bold text-sm tracking-tight italic uppercase">
                    {post.category}
                  </p>
                </div>
                <div className="space-y-1">
