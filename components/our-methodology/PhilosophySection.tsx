          ...
          >
            <div className="bg-[#0A0A0A] p-8 rounded-none border border-[#0A0A0A]">
              ...
              <div className="font-mono text-sm text-white/90 space-y-2">
                <div>
                  <span className="text-[#FF6B00]">const</span> transparency ={" "}
                  {"{"}
                </div>
                <div className="ml-4">
                  fullOwnership: <span className="text-green-400">true</span>,
                </div>
                <div className="ml-4">
                  noBlackBox: <span className="text-green-400">true</span>,
                </div>
                <div className="ml-4">
                  directAccess: <span className="text-green-400">true</span>,
                </div>
                <div className="ml-4">
                  documentation:{" "}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#F9F9F9] px-4 py-2 border border-[#0A0A0A] rounded-none">
                ...
                <span className="font-mono text-xs text-[#0A0A0A]">
                  CODE_TRANSPARENT | OWNERSHIP_COMPLETE
                </span>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-lg text-[#0A0A0A]/70 font-inter font-light leading-relaxed mb-8">
                Many agencies hide their logic. We believe you should own your
                intelligence.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-montserrat font-bold text-[#0A0A0A] mb-2">
                    Full IP Ownership
                  </h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#0A0A0A]/70 font-inter font-light leading-relaxed">
                    We build on your infrastructure (AWS, MongoDB, n8n) so you
                    are never locked into a proprietary vendor.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-[#F9F9F9] p-6 border border-[#E5E5E5] rounded-none">
              <div className="flex items-start gap-3">
                ...
                <p className="text-[#0A0A0A]/80 font-inter font-light leading-relaxed italic">
                  "We don't build black boxes. We build transparent systems that
                  you understand, own, and can maintain long after we're gone."
                </p>
              </div>
            </div>
          </motion.div>
