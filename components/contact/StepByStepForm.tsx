        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-[#0A0A0A]/70 font-montserrat">
              Step through our intelligent intake process to get your project
              started.
            </p>
          </motion.div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mb-8">
                  ...
                  <p className="text-[#0A0A0A]/70 font-montserrat">
          ...
          <div className="mt-6 text-center">
            <div className="inline-flex items-center gap-2 bg-[#F5F5F5] px-4 py-2 rounded-full">
              ...
              <span className="text-sm font-mono text-[#0A0A0A]/70">
                FORM_STATUS: {isStepValid() ? "VALID" : "INCOMPLETE"} | STEP:{" "}
                {currentStep}/{steps.length}
              </span>
            </div>
          </div>
