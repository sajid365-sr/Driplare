      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          <span className="font-mono text-primary text-sm font-bold uppercase tracking-[0.3em]">
            [ Impact_Verification_Protocol ]
          </span>
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter">
            Proof of <span className="text-primary italic">Efficiency.</span>
          </h1>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg md:text-xl font-medium">
            We don't just write code; we solve bottlenecks. Explore the
            technical breakdown of our high-impact deployments.
          </p>
        </motion.div>
      </div>
    </section>
